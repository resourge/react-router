...
> {
	...
	private _includeCurrentURL?: ((currentHash: URL) => string | undefined) | boolean;
	 ...
	 * @param currentURL {boolean | ((currentHash: URL) => string | undefined)} @default true
	 */
	public currentURL(currentURL: ((currentHash: URL) => string | undefined) | boolean = true) {
		const _this = this.clone();
